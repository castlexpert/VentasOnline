...
async function main() {
        ...
        data: [
            {
                ...
                address: "Carretera Vieja de Naranjo, 800 este de la escuela Buenos Aires, Provincia de Alajuela, Palmares",
                phone: "+506 2453 0133",
            ...
            },
            {
                ...
                address: "De la Cooperativa Coopecalifornia, 6 Kms al Norte, Frente a la Arrocera Cooparroz R.L., Playón Sur de Parrita, Provincia de Puntarenas",
                phone: "+506 2453 0133",
                email: "info@concrepal.net"
            },
            {
                name: "CONCREPAL LIBERIA",
                address: "Frente a la entrada del Pelón de la Bajura, Provincia de Guanacaste, Bagaces",
                phone: "+506 2453 0133",
                email: "info@concrepal.net"
            }
        ],
    ...
    await prisma.product.upsert({
        ...
        create: {
            ...
            description: "Bloques de concreto para construcción con especificaciones técnicas.",
            body: {
                items: [
                    {
                        name: "Block 12",
